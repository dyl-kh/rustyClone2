...
const MenuSmall: Component = () => {
  return (
    <div class="flex flex-col bg-[rgb(22,27,42)]">
      <MidNav />
      <div class="flex flex-col bg-[rgb(22,27,42)] w-full p-6 z-50 font-oswald font-semibold gap-3 text-[rgb(32,39,61)]">
        <div class="flex items-center gap-3">
          <button class="flex animated-button rounded items-center justify-center gap-1 flex-1 p-3 hover:outer-yellow-glow">
            <AiFillGift />
